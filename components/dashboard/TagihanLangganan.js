...
const AdminDasbor = ({ columns, dataCourse, filterInput, setFilterInput }) => {
      ...
      <div className={styles.course_request}>
        <div className={styles.course_request_header}>
          <div className={styles.course_request_header_group}>
            <div className={styles.course_request_header_title}>Daftar {Cookies.get("role") === "tutor" ? "Tagihan" : "Langganan"}</div>
          </div>
          <div className={styles.course_request_header_search}>
            <Image src={Search} alt="" width={15} />
            <input value={filterInput} onChange={handleFilterChange} placeholder={`Cari Id ${Cookies.get("role") === "tutor" ? "Tagihan" : "Langganan"}`} />
          </div>
        </div>
